...
Version  : 3.3.7
Release  : 27
URL      : https://cran.r-project.org/src/contrib/RandomFields_3.3.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RandomFields_3.3.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576532957
