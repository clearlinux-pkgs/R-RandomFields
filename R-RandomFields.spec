...
Version  : 3.3.10
Release  : 41
URL      : https://cran.r-project.org/src/contrib/RandomFields_3.3.10.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RandomFields_3.3.10.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632327065
