...
Version  : 3.3.13
Release  : 45
URL      : https://cran.r-project.org/src/contrib/RandomFields_3.3.13.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RandomFields_3.3.13.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635866960
