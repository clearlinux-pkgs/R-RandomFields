...
Version  : 3.3.4
Release  : 13
URL      : https://cran.r-project.org/src/contrib/RandomFields_3.3.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RandomFields_3.3.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1551723108
